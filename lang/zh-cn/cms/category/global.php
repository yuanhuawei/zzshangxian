...
return array(
	...
	'cms_category_list_pages_template' => '栏目列表页分页模板',
	'cms_category_view_pages_template' => '栏目内容页分页模板',
	'cms_category_pages_template_note' => '对应语言包中的键值，在语言包中做好分页模板之后把键值填入。',
	'cms_category_item_template' => '栏目列表显示样式',
	'cms_category_item_count' => '内容数',
	'cms_category_merge' => '合并栏目',
	'cms_category_clone' => '克隆栏目',
	'cms_category_clone_to' => '选择克隆到哪个栏目',
	'cms_category_fix' => '重新统计栏目内容数',
	'cms_category_frame' => '封面图片',
	'cms_category_list_title_length' => '栏目列表标题长度',
	'cms_category_list_title_dot' => '标题超过字数是否用省略号表示',
	...
	'cms_category_order_by_timestamp' => '发布时间',
	...
	'htmlstatus'=>'静态化',
	'html_list_url_rule_mobile'=>'静态列表页URL规则(移动)',
	'html_view_url_rule_mobile'=>'静态内容页URL规则(移动)',
);