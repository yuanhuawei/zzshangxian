...
return array(
	...
	'office_item_html_unwritable' => '你的目录 ({$1}) 不可写，请确定你的目录可写。',
	'office_item_spidering' => '正在采集',
	'office_item_spider_done' => '采集完成',
	
	'office_item_allow_comment' => '是否开启评论功能',
	'office_item_comment_verify' => '评论是否需要审核',
	'office_item_comment_per_page' => '评论每页显示的条数',
	'office_item_comment_view_per_page' => '内容页显示的评论条数',
	'office_item_allow_mood' => '是否开启心情功能',
	'no_office_category_to_html' => '没有栏目要静态化',
	'no_office_item_to_html' => '没有内容要静态化',
