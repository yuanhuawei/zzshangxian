...
$__label['list_chm_img1'] = $LABEL->display('list_chm_img1');
$__label['list_chm_con1'] = $LABEL->display('list_chm_con1');
...
<div class="container">
<div class="chm-box">
<h3 class="chm-title">$CAT[name]</h3>
<div class="chm-pic">{$__label['list_chm_img1']}</div>
<div class="chm-con">
{$__label['list_chm_con1']}
</div>
<a href="javascript:void(0);" class="returnTop  fr">回到顶部</a>
</div>
</div>
</div>
<script type="text/javascript">
